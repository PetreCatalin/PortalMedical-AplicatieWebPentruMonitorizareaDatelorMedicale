<%@ Page Title="Glicemie" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Glicemie.aspx.cs" Inherits="Glicemie"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <h1 style="color:blue;font-style:oblique;background-color:white;font-weight:bold;text-align:center;font-family:Lobster;"> Monitorizare Glicemie </h1>
    <br /> <br />

    <div style="margin-right:30%;margin-left:30%;color:blue;font-style:oblique;font-weight:bold;text-align:center;">
    <div class="form-group">
      <label for="glicemie" style="font-size:200%;"> Valoare glicemie (in mg/dl) </label>
      <input type="number" class="form-control" id="glicemie" placeholder="Exemplu: 80" runat="server" />
    </div>
    <br />

        <div style="font-style:oblique;text-align:center;">
                    <div class="btn-group">
                    <asp:Button ID="Button1" runat="server" Text="Adaugare" OnClick="Button1_Click" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Italic="True" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" />
                    </div>
        </div>
    ...
    <br /><br />
     ...
     <div style="background-color:white;opacity:0.8;">
         ...
         <br />
           ...
           <div style="font-style:oblique;text-align:center;">
                    <div class="btn-group">
                    <asp:Button ID="Button2"  runat="server" Text="Afisare" OnClick="Button2_Click" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Italic="True" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1" />
                    </div>
           </div>
    ...
    <div class="container" visible="false" id="tabelGlicemie" runat="server" style="text-align:center;width:100%;background-color:#acf!important;color:blue;opacity:0.90;font-style:oblique;font-weight:bold;">
