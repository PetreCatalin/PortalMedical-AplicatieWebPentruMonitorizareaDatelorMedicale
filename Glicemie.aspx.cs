...
public partial class Glicemie : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        lblModalBody.ForeColor = System.Drawing.Color.Red;
        tabelGlicemie.Visible = false;
    }

    protected void Button1_Click(object sender, EventArgs e)
    {
        var valoare = glicemie.Value;
        ...
        else
        {
            ...
            else
            {
                ...
                cmd.CommandText = "INSERT INTO Glicemie (Utilizator,Valoare,Data) VALUES (@numeUtilizator, @valoare, @data)";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                string query = "SELECT Valoare,Data,Id FROM Glicemie WHERE Utilizator = '" + numeUtilizator + "' AND Data >='" + data1 +"' AND Data <='" + data2 +"'  Order by Data ASC";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        string query = "DELETE FROM Glicemie WHERE Id='" + id + "'";
        SqlCommand cmd = new SqlCommand(query, con);
        cmd.ExecuteNonQuery();
