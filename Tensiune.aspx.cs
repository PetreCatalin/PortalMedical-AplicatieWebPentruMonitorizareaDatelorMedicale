...
public partial class Tensiune : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        lblModalBody.ForeColor = System.Drawing.Color.Red;
        tabelTensiune.Visible = false;
    }

    protected void Button1_Click(object sender, EventArgs e)
    {
        var valoare = tensiune.Value;
        ...
        else
        {
            ...
            else
            {
                ...
                cmd.CommandText = "INSERT INTO Tensiune (Utilizator,Valoare,Data) VALUES (@numeUtilizator, @valoare, @data)";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                string query = "SELECT Valoare,Data,Id FROM Tensiune WHERE Utilizator = '" + numeUtilizator + "' AND Data >='" + data1 + "' AND Data <='" + data2 + "'  Order by Data ASC";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        string query = "DELETE FROM Tensiune WHERE Id='" + id + "'";
        SqlCommand cmd = new SqlCommand(query, con);
        cmd.ExecuteNonQuery();
