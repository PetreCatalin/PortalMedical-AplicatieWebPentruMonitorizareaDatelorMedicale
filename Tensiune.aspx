<%@ Page Title="Tensiune" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Tensiune.aspx.cs" Inherits="Tensiune"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <h1 style="color:blue;font-style:oblique;background-color:white;font-weight:bold;text-align:center;font-family:Lobster;"> Monitorizare Tensiune </h1>
    <br /> <br />

    <div style="margin-right:30%;margin-left:30%;color:blue;font-style:oblique;font-weight:bold;text-align:center;">
    <div class="form-group">
      <label for="tensiune" style="font-size:200%;"> Tensiune (in mm Hg) </label>
      <input type="number" step="0.01" class="form-control" id="tensiune" placeholder="Exemplu: 130,80" runat="server" />
    </div>
    <br />
    ...
    <div class="container" visible="false" id="tabelTensiune" runat="server" style="text-align:center;width:100%;background-color:#acf!important;color:blue;opacity:0.90;font-style:oblique;font-weight:bold;">
